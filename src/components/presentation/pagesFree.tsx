...
const posts = [
  {
    img: "aboutus.jpg",
    title: "Nosotros",
    desc: "Conoce a CR Soluciones Industriales: asesoría, diseño, construcción y montajes industriales.",
    url: "/about",
  },
  {
    img: "signin.jpg",
    title: "Iniciar sesión",
    desc: "Accede a tu cuenta para gestionar servicios o solicitudes.",
    url: "/login",
  },
  {
    img: "404.jpg",
    title: "Página no encontrada",
    desc: "Si buscas información o contacto, escríbenos por WhatsApp al 311-360.84.91.",
    url: "/404",
  },
];
        ...
        <div className="container mx-auto px-8 py-10">
          <div className="mb-16 text-left">
            ...
            <Typography color="blue-gray">
              Explora nuestra web: conoce quiénes somos, inicia sesión o navega por el sitio.
            </Typography>
          </div>
